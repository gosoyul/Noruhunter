...
class Extractor(ABC):
    ...
    def extract(self, parent=None):
        ...
        # result = window.show_message("추출", "진행하시려면 [확인]을 눌러주세요.", with_cancel=True)
        ...
        extracted_text = ['흠..그정돈가', '서클원', '270', '3570', '온라인', 'Lv.59', '주넌', '서클원', '270', '3570', '온라인',
                          'Lv.52',
                          '윤우', '서클원', '270', '3570', '온라인', 'Lv.55', '덱켄', '서클원', '270', '3090', '온라인',
                          'Lv.53', '지휘관',
                          '서클원', '270', '2910', '온라인', 'Lv.46', '후하후하후하', '서클원', '270', '2906', '온라인', 'Lv.48',
                          '커셀',
                          '서클원', '230', '3530', '온라인', 'Lv.52', '브라운더스트', '서클원', '230', '3530', '온라인', 'Lv.51',
                          'Orca',
                          '서클원', '270', '3130', '오늘', 'Lv.49', '산룡', '서클원', '270', '3020', '오늘', 'Lv.53', '스즈메',
                          '서클원',
                          '270', '360', '오늘', 'Lv.38', '시안', '서클원', '270', '2910', '오늘', 'Lv.48', 'kirioka',
                          '서클원',
                          '270', '2220', '오늘', 'Lv.43', '미텔', '서클원', '270', '2910', '오늘', 'Lv.49', '춘전이언제나옴',
                          '서클장',
                          '270', '5392', '오늘', 'Lv.60', '니체', '서클원', '270', '2760', '오늘', 'Lv.48', '초련', '서클원',
                          '270',
                          '2900', '오늘', 'Lv.48', '잉도밍', '서클원', '270', '3390', '오늘', 'Lv.53', '지휘관', '서클원',
                          '270',
                          '2910', '오늘', 'Lv.51', 'ahl', '서클원', '270', '2800', '오늘', 'Lv.46', '지휘관', '서클원',
                          '180', '180',
                          '오늘', 'Lv.59', '지휘관', '서클원', '270', '2910', '오늘', 'Lv.52', '이삭', '서클원', '270', '3570',
                          '오늘',
                          'Lv.59', 'bmtoo', '서클원', '270', '270', '오늘', 'Lv.52', '청부리', '서클원', '270', '3550',
                          '오늘',
                          'Lv.53', '하임달', '서클원', '270', '3570', '오늘', 'Lv.44', '가양동사냥개', '서클원', '270', '2770',
                          '오늘',
                          'Lv.53', '댕청마녀', '서클원', '270', '270', '오늘', 'Lv.53', '아레타', '서클원', '270', '270', '오늘',
                          'Lv.53', '댕청', '서클원', '180', '2480', '1일 전', 'Lv.45']
